...
public class BookingBuilder{
    ...
    public BookingBuilder setUserName(String userName) {
    ...
    public BookingBuilder setDuration(String duration) {
        this.duration = duration;
        return this;
    }

    public BookingBuilder setSpotName(String spotName) {
    ...
    public BookingBuilder setPaymentStat(String paymentStat) {
        this.paymentStat = paymentStat;
        return this;
    }

    public BookingBuilder setLicenceNum(String licenceNum) {
...
//				System.out.println("userName:" + val[3] + ",  "+ "userType:" + val[1] + ", " +  "password:" + val[6]);
	...
	public void bookparkingSpace(String userName, String bookingID, String date, String time, 
		...
		Booking booking = new BookingBuilder().setUserName(userName).setBookingID(bookingID).setDate(date).setTime(time).setDuration(duration).setSpotName(spotName).setPrice(price).setPaymentStat(paymentStat).setLicenceNum(licenceNum).createBooking();
